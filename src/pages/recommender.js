          ...
          <div class="bg-gray-200 m-5 shadow-lg  overflow-hidden relative pt-5">
            <div class="m-20 bg-white shadow-lg rounded-3xl  text-start w-1/2 py-12 px-4 sm:px-6 lg:py-16 lg:px-8 z-20">
              <h2 class=" text-4xl font-extrabold text-black  ">
                <span class="block ">Where do you want to go?</span>
                <span class="block text-blue-500 ">pick a city</span>
              </h2>
              <div></div>
            ...
            <div className=" ">
              <img
                src="https://pngimg.com/uploads/sphinx/sphinx_PNG23.png"
                class="absolute top-0 right-0 hidden h-full w-4/6 lg:block p-20"
              />
            </div>
          </div>
        </div>
  ...
  {loading &&  (
          <div className="text-center h-96">
            <div role="status" className="p-6">
             ...
             <p className="text-xl"> finding your best matches </p>
            </div>
          </div>
        )}
     { !loading && <div className="grid-container p-3 justify-center">
