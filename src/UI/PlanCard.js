    ...
    <Fragment>
      <div className=" reco-mini-card mt-4 shadow-2xl mr-8 ml-8 border border-gray-200 rounded-lg  dark:bg-gray-800 dark:border-gray-700">
        ...
        <div className=" grid-cards">
          <div>
            <h5 className="mb-2 text-2xl font-bold text-gray-900 dark:text-white">{item.name} {item.attraction_name} </h5>
          </div>
          <div className="flex justify-start ">
            <p className=" desc text-xl  font-normal text-gray-700 dark:text-gray-400 truncate">{item.city} </p>
          </div>
          <div>
